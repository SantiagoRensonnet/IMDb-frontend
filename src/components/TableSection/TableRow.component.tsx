...
import { MovieTitleTooltipWrapper } from "./MovieTitleTooltipWrapper.component";
//hooks
...
export const TableRow = ({
  ...
  return (
    <MovieTitleTooltipWrapper movieTitle={title}>
      <tr className="h-28">
        ...
        <td className="table-data text-center sm:text-left">
          {runtime} minutes
        </td>
      </tr>
    </MovieTitleTooltipWrapper>
  );
};
